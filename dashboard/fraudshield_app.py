...
# creditcard.csv is 144MB — not uploaded to GitHub
# All statistics pre-computed from full dataset analysis
...
# ── Hardcoded Real Transaction Examples ───────────────────
FRAUD_EXAMPLE = {
...
def load_models():
    ...
    scaler_path = os.path.join(base, 'models',
    ...
    if not models_loaded:
        ...
        if score_btn or use_fraud or use_legit:
            ...
            if use_fraud:
                ...
                features[29] = 2   # 2AM — peak fraud hour
                ...
                for i in range(1, 29):
                    features[i-1] = example[f'V{i}']
                features[28] = np.log1p(amount)
                features[29] = 10  # 10AM — safest hour
